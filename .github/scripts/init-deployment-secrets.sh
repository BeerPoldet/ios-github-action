...
cp ./.github/secrets/provision_profile.mobileprovision ~/Library/MobileDevice/Provisioning\ Profiles/provision_profile.mobileprovision
open .github/secrets/provision_profile.mobileprovision
